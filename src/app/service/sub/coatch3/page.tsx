    ...
    <>
      ...
      <div className="max-w-4xl mx-auto p-8 shadow-lg rounded-2xl">
        <h2 className="text-3xl font-bold text-gray-400 mb-6 text-center">
          Professional Training Program - Captain Mohamed El-Kasaby
        </h2>
        
        <p className="text-gray-700 text-lg mb-4">
          Specialist in creating customized training plans tailored to your fitness and health needs.
        </p>

        <div className="mt-6">
          <h3 className="text-2xl font-semibold text-gray-400 mb-3">Comprehensive Workout Programs</h3>
          <ul className="list-disc list-inside text-gray-400 space-y-2">
            <li>Weight loss and fat burning strategies</li>
            <li>Muscle gain and strength development</li>
            <li>Overall physical improvement and endurance</li>
          </ul>
        </div>

        <div className="mt-6">
          <h3 className="text-2xl font-semibold text-gray-400 mb-3">Sustainable Fitness Approach</h3>
          <ul className="list-disc list-inside text-gray-400 space-y-2">
            <li>Utilizing modern training methodologies</li>
            <li>Personalized balanced nutrition guidance</li>
