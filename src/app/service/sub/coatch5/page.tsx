    ...
    <>
      ...
      <div className="max-w-4xl mx-auto p-8 shadow-lg rounded-2xl">
        <h2 className="text-3xl font-bold text-gray-400 mb-6 text-center">
          Professional Training Program - Captain Raneem Kamal
        </h2>
        
        <p className="text-gray-700 text-lg mb-4">
          A specialist in designing personalized training programs to help you achieve your fitness goals with confidence and strength.
        </p>

        <div className="mt-6">
          <h3 className="text-2xl font-semibold text-gray-400 mb-3">Customized Training Plans</h3>
          <ul className="list-disc list-inside text-gray-400 space-y-2">
            <li>Fitness improvement and body toning</li>
            <li>Strength and endurance building</li>
            <li>Personalized workout programs for continuous progress</li>
          </ul>
        </div>

        <div className="mt-6">
          <h3 className="text-2xl font-semibold text-gray-400 mb-3">Modern Training Approach</h3>
          <ul className="list-disc list-inside text-gray-400 space-y-2">
            <li>Diverse and effective workout routines</li>
            <li>Utilizing modern training techniques</li>
            <li>Boosting energy levels and self-confidence</li>
          </ul>
          ...
          <option value="">-- Women s Gym --</option>
                ...
                <option value="half-yearly">Personalized Training - 350 EGP</option>
                </select>
