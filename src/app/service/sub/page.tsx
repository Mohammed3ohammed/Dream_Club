...
const page = () => {
  return (
    <>
        ...
        <h1 className='text-3xl font-bold mt-10 italic text-orange-500'>اشترك معنا</h1>
        </div>
        <div>
            ...
            <div className='mb-20 flex justify-center items-center'>
                ...
                <label>السن</label>
                <input type='text' required placeholder='السن' className=' h-10 rounded-2xl outline-none transition focus:outline-orange-500 p-2' /> 
                <label>الوزن</label>
                <input type='text' required placeholder='الوزن' className='h-10 rounded-2xl outline-none transition focus:outline-orange-500 p-2' />
                <label>الطول</label>
                <input type='text' required placeholder='الطول' className='h-10 rounded-2xl outline-none transition focus:outline-orange-500 p-2' />
    ...
    <option value="half-yearly">جمباز من سن 4 - 7 200جنية</option>
                ...
                <input type='submit' value="اشترك الأن" className="border-2 border-solid border-orange-500 py-2 px-6 mt-5 rounded-full text-white hover:bg-orange-500 hover:text-white transition duration-300 w-full sm:w-auto text-center cursor-pointer"  />
            </form>
                </div>
