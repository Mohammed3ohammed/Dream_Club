    ...
    <>
      ...
      <div className="max-w-4xl mx-auto p-8 shadow-lg rounded-2xl">
        <h2 className="text-3xl font-bold text-gray-400 mb-6 text-center">
          Professional Training Program - Captain Fares El-Monakhly
        </h2>
        
        <p className="text-gray-700 text-lg mb-4">
          I help you achieve your fitness goals through personalized training programs tailored specifically for you.
        </p>

        <div className="mt-6">
          <h3 className="text-2xl font-semibold text-gray-400 mb-3">Personalized Training Approach</h3>
          <ul className="list-disc list-inside text-gray-400 space-y-2">
            <li>Improving physical performance and endurance</li>
            <li>Weight loss and muscle-building strategies</li>
            <li>Balanced and progressive fitness training</li>
          </ul>
        </div>

        <div className="mt-6">
          <h3 className="text-2xl font-semibold text-gray-400 mb-3">Comprehensive Fitness Strategy</h3>
          <ul className="list-disc list-inside text-gray-400 space-y-2">
            <li>Latest fitness techniques for optimal results</li>
            <li>Customized nutritional guidance</li>
            <li>Enhancing confidence and overall health</li>
          </ul>
