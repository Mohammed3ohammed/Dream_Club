...
const Footer = () => {
  return (
    <footer className="bg-white opacity-60 text-black">
 ...
 <div className="flex flex-col items-center text-center ">
    ...
    <p className="p-4  md:w-full w-96 mt-3 leading-relaxed">Stamina is the ability to sustain prolonged physical or mental effort. it involves cardlovascular and muscular endurance,
        ...
        <ul className="flex flex-col justify-center items-center   gap-6">
          ...
          <div  className="flex justify-center gap-10">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-8 h-8  transform transition duration-300 hover:scale-125">
          ...
          <div className="flex flex-col justify-end mr-10" dir='rtl'>
           <span>
                <Link href="#">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" width="1.5" stroke="currentColor" className="size-8  transform transition duration-300 hover:scale-125 p-4">
                <path line-cap="round" line-join="round" d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1 1 15 0Z" />
                </svg>
                  الفرع الأول الحيار ابو المطامير البحيرة
                </Link>
            </span>
            <span>
                <Link href="#">
