    ...
    <nav className="z-50">
          ...
          onKeyDown={(e) => {
            ...
            <li className="py-1 md:py-0 mt-1 sm:mt-0 z-50 transition hover:text-orange-500"><Link href="/contact" onClick={() => setMenuOpen(false)}>Contact</Link></li>
              ...
              <Link href="/log/admin">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-6 h-6 text-orange-500 transform transition duration-300 hover:scale-150 animate-bounceLight" onClick={() => setMenuOpen(false)}>
