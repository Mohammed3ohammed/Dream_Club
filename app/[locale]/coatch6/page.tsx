  ...
  const handleSubscribe = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await axios.post(
        ...
        { 
          plan,
          program_id: 6 // تحديث الـ program_id
        }, 
        {
          headers: {
              ...
              <div className="max-w-4xl mx-auto p-8 shadow-lg rounded-2xl">
                ...
                <div className="mt-6">
                  ...
                  <form onSubmit={handleSubscribe} className='flex flex-col gap-5 lg:w-8/12 p-4 md:w-8/12 w-full justify-center'>
                    ...
                    <button
                      type="submit"
                      className="border-2 border-solid border-orange-500 py-2 px-6 mt-5 rounded-full text-white hover:bg-orange-500 hover:text-white transition duration-300 w-full sm:w-auto text-center"
                    >
                      {t("button")}
                    </button>
                  </form>
